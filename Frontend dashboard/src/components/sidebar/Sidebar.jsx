...
const Sidebar = ({ sidebarOpen, closeSidebar }) => {
  ...
  return (
    <div
    ref={sidebarRef}
      className={`bg-white w-[18.125rem] z-20 px-5 fixed top-0 left-0 h-full   flex flex-col shadow-custom-shadow bg-transparent  absolute md:relative md:z-20  h-screen md:-translate-x-0 transition duration-150 ease-out ${
        sidebarOpen ? "" : "-translate-x-[295px] "
      }`}
    >
      <div
      ...
      <nav className="flex-1">
        <ul>
          ...
          <li>
            ...
            >
              <TbMailFilled className="text-black hover:text-white" size={24} />
              Emails
            </Link>
          </li>
        </ul>
